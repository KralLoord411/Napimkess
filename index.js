      ...
      if (!message.member.hasPermission("BAN_MEMBERS")) {
        ...
        if (uyarisayisi === null) {
          let uyari = new Discord.RichEmbed()
            .setColor("BLACK")//GhostKiller
            .setTitle("GhostKiller Reklam-Engel!")
            .setDescription(
        ...
        if (uyarisayisi === 3) {
          message.delete();
          await kullanici.ban({
            reason: `GhostKiller Reklam-Engel Sistemi!`
          });
          db.delete(`reklamuyari_${message.author.id}`);
          let uyari = new Discord.RichEmbed()//GhostKiller
            .setColor("BLACK")
            .setTitle("GhostKiller Reklam Kick Sistemi")
            .setDescription(
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "nasılsın") {
    msg.reply("**İyim Sen Nasılsın?**");
  }
});

client.on("message", msg => {
  if (msg.content.toLowerCase() === "iyi sen") {
    msg.reply("**Bende İyi Ne Olsun Aynı işler**");
  }
});
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "napıyonuz") {
    msg.reply("**Bot arkadaşlarımla internet kafelerin internet şebekelerini hackliyoduk sen napıyon **");
  }
});
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "bende seni hackliyorum") {
    msg.reply("**Lafı koydum lafı napim  **");
  }
});

client.on("message", msg => {
  if (msg.content.toLowerCase() === "ağla") {
    msg.reply("** hahahahaha Çok Komik Ğ**");
  }
});
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "what are you doing") {
    msg.reply("**We were hacking the internet networks of internet cafes with my bot friends, what are you doing?**");
  }
});

client.on("message", msg => {
  if (msg.content.toLowerCase() === "I'm hacking you too") {
    msg.reply("**I put the word, what do I do  **");
  }
});
///////////////////////////////////////////////////////////////////////////////